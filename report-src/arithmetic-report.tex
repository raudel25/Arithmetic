...
%-----------------------------------------------------------------------------------
\tutors{\\
Msc. Fernando Raul Rodríguez Flores, \emph{Facultad de Matemática y Computación, Universidad de La Habana}}
...
%---------------------------------------------------------------------------------	
	...
	\bibitem{wiki} Floating Point Arithmetic: Issues and Limitations URL: \href{https://docs.python.org/3.9/tutorial/floatingpoint.html}
	  {https://docs.python.org/3.9/tutorial/floatingpoint.html}.
		Consultado en 19 de noviembre de 2022.
		
	\bibitem{Donald E. Knuth.} Donald E. Knuth.(1997) The Art of Computer Programming. Chapter 4 – Arithmetic, (1997).	
